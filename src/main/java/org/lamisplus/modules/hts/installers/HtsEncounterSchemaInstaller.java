...
@Order(20)
@Installer(name = "hts-encounter-schema-installer-new-again-bug-resolved", description = "Creates the hts_encounter table - V3: boolean archived, patient_id, patient_uuid, facility_uuid, observation column", version = 44)
